...
function openReview(category) { state.category = category; state.page = 1; state.selected.clear(); state.reviewItems = []; state.reviewTotal = 0; state.reviewComplete = false; showView("review"); loadReview(true); }
